...
namespace XCFrameworkBase
{
    ...
    public struct SUpdatableVersionList
    {
        ...
        public SUpdatableVersionList(string applicableGameVersion, int internalResourceVersion, SAsset[] assets, SResource[] resources, SFileSystem[] fileSystems, SResourceGroup[] resourceGroups)
        {
            m_IsValid = true;
